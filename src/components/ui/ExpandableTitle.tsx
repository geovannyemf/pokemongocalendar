...
/**
 * Componente mejorado para títulos expandibles con comportamiento tipo Facebook
 * Responsabilidad única: Manejar la expansión/contracción de texto largo
 */
export function ExpandableTitle({ title, onToggle }: ExpandableTitleProps) {
      ...
      >
        {!isExpanded && isOverflowing ? (
          <span>
            ...
            <span 
              className="text-gray-500 hover:text-gray-700 cursor-pointer font-normal ml-1 text-sm"
          ...
          <span>
            ...
            {isExpanded && isOverflowing && (
              <span 
                className="text-gray-500 hover:text-gray-700 cursor-pointer font-normal ml-2 text-sm"
                onClick={handleToggle}
              >
                Ver menos
              </span>
